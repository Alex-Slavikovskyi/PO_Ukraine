...
export const CardWork = ({ card }) => {
  ...
  return (
    <div className='min-w-[268px] max-w-[300px] md:w-[220px] md-2:w-[290px] lg:w-[360px] border-l-4 border-[#0C5AB5] rounded-tl-[32px]'>
      <div className='py-6 px-4 lg:py-8 lg:px-6 '>
        <div className='h-[219px] md:h-[266px] text-ellipsis overflow-hidden '>
          <div className='w-[28px] h-[28px] lg:w-[36px] lg:h-[36px]'>
            <img src={card.logoCard} />
          </div>
          <div className='sm:max-lg:h-[44px] mt-[20px] lg:mt-8'>
            <h3 className='font-bold text-sm md:text-base lg:text-xl '>{card.title}</h3>
          </div>
